...
DEFINE_GRADIENT_PALETTE( Night_Midnight_gp ) {
    0,  15, 25, 27,
   36,  22, 48, 91,
   59,  32, 80,203,
   74, 110,154,228,
...
DEFINE_GRADIENT_PALETTE( Gold_Orange_gp ) {
    0, 244, 88, 11,
   21, 247,118, 26,
   40, 249,152, 50,
   62, 252,201, 82,
...
DEFINE_GRADIENT_PALETTE( Analogous_02_gp ) {
    0,  32,  0,123,
   63, 110,  5, 79,
  127, 255, 23, 45,
  191, 255, 21, 30,
...
DEFINE_GRADIENT_PALETTE( Analogous_04a_gp ) {
    0,  67, 55,255,
   42,  67, 55,255,
   84,  67, 55,255,
   84, 120, 33,255,
...
DEFINE_GRADIENT_PALETTE( Cyan_Orange_Stripped_gp ) {
    0,   1,108,212,
   60,   1,108,212,
  121,   1,108,212,
  121,   0,  0,  0,
...
DEFINE_GRADIENT_PALETTE( Cyan_White_Green_gp ) {
    0,   0,255,255,
   63,  42,255,255,
  127, 255,255,255,
  191,  42,255, 45,
...
DEFINE_GRADIENT_PALETTE( IKat_Radial_gp ) {
    0,   3,  7,  4,
   56, 255,255,255,
  127,   3,  7,  4,
  196, 255,255,255,
...
DEFINE_GRADIENT_PALETTE( Teal_Blue_gp ) {
    0,   1, 73, 88,
   63,   1, 43, 52,
  127,   1, 77, 95,
  196,   1, 58, 67,
...
DEFINE_GRADIENT_PALETTE( Ldby_Orange_gp ) {
    0, 217, 45, 17,
   61, 179, 21,  8,
  130, 222, 49, 21,
  193, 203, 32,  7,
...
DEFINE_GRADIENT_PALETTE( green_purple_d07_gp ) {
    0,   1, 90, 12,
   36,   1, 90, 12,
   36,  12,147, 51,
   72,  12,147, 51,
...
DEFINE_GRADIENT_PALETTE( knoza_00_gp ) {
    0,  56, 56,237,
    1, 115,  1,  1,
   24, 115,  1,  1,
   25, 237,130, 46,
...
DEFINE_GRADIENT_PALETTE( knoza_18_gp ) {
    0,   8,  1,  1,
    2,   1,239,  1,
   51,   1,239,  1,
   52, 175,130,  1,
...
DEFINE_GRADIENT_PALETTE( calpan_18_gp ) {
    0, 133, 31,137,
    1, 117,  2, 88,
   24, 117,  2, 88,
   25, 239,241,245,
...
DEFINE_GRADIENT_PALETTE( calbayo_18_gp ) {
    0, 210,131,  1,
   60, 210,131,  1,
   62,  41,  2,  3,
   99,  41,  2,  3,
...
DEFINE_GRADIENT_PALETTE( fib53_15_gp ) {
    0, 239, 11, 31,
  101, 239, 11, 31,
  101, 239,241,240,
  127, 239,241,240,
...
DEFINE_GRADIENT_PALETTE( grindylow_15_gp ) {
    0, 101,241,105,
  127,  26,182,105,
  255,  26,151, 80};
...
DEFINE_GRADIENT_PALETTE( konjo_08_gp ) {
    0, 213,229,240,
  127, 213,229,240,
  128, 133,168,188,
  150, 133,168,188,
...
DEFINE_GRADIENT_PALETTE( konkikyo_19_gp ) {
    0,   1,  2,  9,
  101,   1,  2,  9,
  102, 199,213,252,
  122, 199,213,252,
...
DEFINE_GRADIENT_PALETTE( sulz_22_gp ) {
    0, 247, 54,  7,
    1, 247, 54,  7,
   24, 247, 54,  7,
   25,   1,  1,  1,
...
DEFINE_GRADIENT_PALETTE( Pills_2_gp ) {
    0, 192,147, 11,
  127, 148,104, 59,
  255, 109, 69,155};
...
DEFINE_GRADIENT_PALETTE( Pink_Yellow_Orange_1_gp ) {
    0, 255,199,  0,
   34, 255,121,  0,
  106, 255, 63,  0,
  168, 194, 13,  6,
...
DEFINE_GRADIENT_PALETTE( es_candide_30_gp ) {
    0, 242,244,242,
   63, 133,255,137,
  127, 242,146,194,
  191, 104,187,245,
...
DEFINE_GRADIENT_PALETTE( es_chic_16_gp ) {
    0,   4,  1,  1,
   51, 135, 99,  3,
   63, 222,248,160,
   76, 110,118, 50,
...
DEFINE_GRADIENT_PALETTE( es_landscape_57_gp ) {
    0,  27, 91,  0,
   89, 126,171,106,
   91, 157,199,255,
  143,  45,142,245,
...
DEFINE_GRADIENT_PALETTE( es_landscape_47_gp ) {
    0, 175,125, 44,
   38,  88, 45,  3,
   58,  46, 27,  1,
   76,  20, 14,  0,
...
DEFINE_GRADIENT_PALETTE( es_landscape_10_gp ) {
    0, 244,213, 55,
   24, 242,209, 53,
   51, 237,203, 51,
   63, 210,252,252,
...
DEFINE_GRADIENT_PALETTE( es_landscape_76_gp ) {
    0, 252,178, 82,
  127, 208, 91,  7,
  132, 153,173,188,
  191, 163,187,221,
...
DEFINE_GRADIENT_PALETTE( es_landscape_60_gp ) {
    0, 161,112, 18,
   51, 130, 78,  1,
   89,  95, 59,  1,
   91, 133,151,140,
...
DEFINE_GRADIENT_PALETTE( es_landscape_51_gp ) {
    0, 128,128,103,
   39, 165,161,144,
   76, 206,195,190,
  114,  15, 71,247,
...
DEFINE_GRADIENT_PALETTE( es_landscape_06_gp ) {
    0,  90,199,  1,
   89, 173,244,252,
  255,  57,175,207};
...
DEFINE_GRADIENT_PALETTE( es_pinksplash_05_gp ) {
    0, 206,  1, 25,
   20, 192, 45, 82,
   38, 179,182,182,
   76, 206,  1, 25,
...
DEFINE_GRADIENT_PALETTE( es_pinksplash_10_gp ) {
    0,  26, 17, 27,
   63, 184,  1, 37,
   76, 234,141,174,
   89, 148,  2, 35,
...
DEFINE_GRADIENT_PALETTE( es_vintage_56_gp ) {
    0, 220,225,221,
   51,  83, 79,  7,
  109,  25,  0,  1,
  119, 255,131, 19,
...
DEFINE_GRADIENT_PALETTE( es_vintage_10_gp ) {
    0,   1,  3,  1,
   51,   7,  1,  1,
  127, 112, 18,  0,
  255, 206,207,182};
...
DEFINE_GRADIENT_PALETTE( purple_sunset_gp ) {
    0,   0,  0,  0,
   31,   1,  1,  1,
   62,   1,  1,  7,
   62,   3,  2,  6,
